...
import {AsyncStorage,ActivityIndicator,Dimensions,TouchableHighlight,ScrollView,renderRow,ListView} from 'react-native';
        ...
        return (
            <Container >
                <View style={{alignItems:'center',flexDirection:'row',justifyContent:'flex-end',
                    ...
                    <TouchableHighlight
                        underlayColor={'#1c375c'}
                        style={{flex:1,height:37,justifyContent:'flex-end',alignItems:'flex-end',backgroundColor:'#1c375c',borderRadius:0}}
